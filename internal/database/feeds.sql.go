...
func (q *Queries) GetFeedByID(ctx context.Context, url string) (uuid.UUID, error) {
	row := q.db.QueryRowContext(ctx, getFeedByID, url)
	var id uuid.UUID
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) GetFeeds(ctx context.Context) ([]GetFeedsRow, error) {
	...
	for rows.Next() {
		var i GetFeedsRow
		if err := rows.Scan(&i.Name, &i.Url, &i.Feedusername); err != nil {
			return nil, err
		}
